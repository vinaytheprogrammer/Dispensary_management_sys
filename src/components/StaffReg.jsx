...
const StaffReg = () => {
      ...
      return (
        <>
          ...
          <div className="form-group mb-4">
            ...
            <input type="password" id="password" name="password" placeholder="Password" className="border p-2 w-full" onChange={handleChange} required />
          </div>
        </>
      );
    }
  ...
  return (
    <div className="register-form p-6 bg-white rounded shadow-lg max-w-lg mx-auto">
      <h1 className="text-2xl font-bold mb-4">Staff/ Doctor Register</h1>
      <form onSubmit={handleSubmit}>
        <div className="form-group mb-4">
          <label htmlFor="userType" className="block mb-2">User Type:</label>
          <select name="userType" id="userType" className="border p-2 w-full" onChange={handleUserTypeChange}>
